"""
Django settings for spartaRIO project.
...
SECRET_KEY = 'django-insecure-^9qpezlfz1^a@f$m*-h#nlrl7uw_w527#b-rfur@(+_ef)b=)u'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["web-production-c304.up.railway.app", 'localhost', '127.0.0.1']
...
LOGIN_REDIRECT_URL = '/area-restrita/'
...
WSGI_APPLICATION = 'spartaRIO.wsgi.application'
